...
const Payment = () => {
    ...
    const {price, availableSeats} = selectedCourse;
    ...
    return (
        <div>
            ...
            <Elements stripe={stripePromise}>
                <CheckoutForm selectedCourse={selectedCourse} updatedAvailableSeats ={updatedAvailableSeats} fixedPrice={fixedPrice}></CheckoutForm>
            </Elements>
        </div>
    );
};
